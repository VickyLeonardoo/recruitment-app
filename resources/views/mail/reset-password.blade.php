        ...
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $data['name'] }},</h1>
                                            <p>You recently requested to reset your password for your MDR Recruit
                                                account. Use the button below to reset it. <strong>This password reset
                                                    is only valid for the next 10 Minutes.</strong></p>
                                            <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                  <a href="{{ config('app.url') . '/reset/password/' . $token }}" class="f-fallback button button--green" target="_blank">
                                                                    Reset your password
                                                                </a>
                                                                </td>
                                                            </tr>
