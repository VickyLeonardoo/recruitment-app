...
<body>
    <span class="preheader">Use this link to active your account. The link is only valid for 10 Minutes.</span>
        ...
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $user_detail['full_name'] }},</h1>
                                            <p>You recently requested to verify your MDR Recruit account. Use the button below to verify it. </p>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                  <a href="{{ config('app.url') . '/verify/account/' . $token }}" class="f-fallback button button--green" target="_blank">
                                                                    Active Account
                                                                </a>
                                                                </td>
                                                            </tr>
