                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea readonly name="description" class="form-control" {{ $errors->has('description') ? 'is-invalid' : '' }}
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea readonly name="requirement" class="form-control" {{ $errors->has('description') ? 'is-invalid' : '' }}
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea readonly name="qualification" class="form-control" {{ $errors->has('qualification') ? 'is-invalid' : '' }}
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select readonly class="form-select {{ $errors->has('type') ? 'is-invalid' : '' }}"
                            ...
                            @role('admin')
                            <div class="form-group mb-3">
                                <input readonly type="submit" class="btn btn-primary form-control-lg form-control"
                                    value="Save">
                            </div>
                            @endrole
                        </div>
