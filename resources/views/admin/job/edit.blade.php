                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="description" class="form-control" {{ $errors->has('description') ? 'is-invalid' : '' }} id="floatingDesc" placeholder="Description" rows="7">{{ $job->description }}</textarea>
                                        @error('title')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select {{ $errors->has('departement_id') ? 'is-invalid' : '' }}" id="floatingDept" name="departement_id">
                                            ...
                                            <option value="{{ $dept->id }}" {{ $job->departement_id == $dept->id ? 'selected' : '' }}>{{ $dept->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control {{ $errors->has('min_salary') ? 'is-invalid' : '' }}"
                                            id="floatingMinSalary" name="min_salary" value="{{ $job->min_salary }}" placeholder="">
                                        @error('min_salary')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control {{ $errors->has('max_salary') ? 'is-invalid' : '' }}"
                                            id="floatingMaxSalary" name="max_salary" value="{{ $job->max_salary }}" placeholder="">
                                        @error('max_salary')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="requirement" class="form-control" {{ $errors->has('description') ? 'is-invalid' : '' }}  placeholder="requirement" rows="7">{{ $job->requirement }}</textarea>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="qualification" class="form-control" {{ $errors->has('qualification') ? 'is-invalid' : '' }} placeholder="Qualification" rows="7">{{ $job->qualification }}</textarea>
                                        @error('qualification')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(id, name) {
                        ...
                        $('#floatingPosition').append('<option value="' + id + '" ' + selected + '>' + name + '</option>');
                    });
